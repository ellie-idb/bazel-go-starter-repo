module github.com/ellie-idb/bazel-go-starter-repo
...
// Necessary for some fixes that haven't made it out into a release yet (workspaceFiles)
replace golang.org/x/tools => golang.org/x/tools v0.29.1-0.20250122211326-fcc9d81f7cff

replace golang.org/x/tools/gopls => golang.org/x/tools/gopls v0.0.0-20250122211326-fcc9d81f7cff
